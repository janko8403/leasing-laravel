                ...
                @if (Auth::check() && Auth::user()->hasRole('Admin'))
                    <ul class="nav">
                        ...
                        <li class="nav-item {{ (Request::is('admin/users', 'admin/users') ? 'active' : '') }}">
                            <a class="nav-link" data-toggle="collapse" href="#flota-nav">
                                <i class="material-icons">person</i>
                                <p>Użytkownicy
                                    <b class="caret"></b>
                                </p>
                            </a>
                            <div class="collapse" id="flota-nav">
                                <ul class="nav">
                                    <li class="nav-item {{ (Request::is('admin/users') ? 'active' : '') }}">
                                        <a class="nav-link" href="{{ url('admin/users') }}">
                                            <span class="sidebar-mini"><i class="material-icons">people</i></span>
                                            <span class="sidebar-normal"> Aktywni użytkownicy</span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{ (Request::is('admin/unactiveusers') ? 'active' : '') }}">
                                        <a class="nav-link" href="{{ url('admin/unactiveusers') }}">
                                            <span class="sidebar-mini"><i class="material-icons">people</i></span>
                                            <span class="sidebar-normal"> Niektywni użytkownicy</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="collapse navbar-collapse justify-content-end">
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                ...
                                @else
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                                        <a class="dropdown-item" href="{{ url('admin/notifications') }}">Brak nowych powiadomień</a>
                                    </div>
                                @endif --}}
                            </li>
                            <li class="nav-item dropdown">
